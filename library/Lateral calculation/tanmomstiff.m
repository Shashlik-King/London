function [ktmomtop ktmombot]  = tanmomstiff(settings,element,pile,teta_topbottom,y_topbottom,kstop,ksbot,i)
% 
%--------------------------------------------------------------------------
% PURPOSE
...
if settings.Apply_Direct_springs && ~ strcmp(element.model_py(i),'Zero soil')
    
   PLAXIS=settings.Plaxis_data.MTheta;
    [ktmomtop ktmombot] =Direct_tan(PLAXIS,element,pile,teta_topbottom,i);
else 
