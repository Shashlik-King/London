...
% PISA formulation 2020
teta_u_n_top  = mutop_n/k_top_n;
teta_u_n_bot  = mubot_n/k_bot_n;
...
% Parameter b1
b_top_n1 = 2*ntop*(tetatop_n1/teta_u_n_top)-(1-ntop)*(1+(tetatop_n1.*k_top_n./mutop_n));
b_bot_n1 = 2*nbot*(tetabot_n1/teta_u_n_bot)-(1-nbot)*(1+(tetabot_n1.*k_bot_n./mubot_n));
% Parameter b2
b_top_n2 = 2*ntop*(tetatop_n2/teta_u_n_top)-(1-ntop)*(1+(tetatop_n2.*k_top_n./mutop_n));
b_bot_n2 = 2*nbot*(tetabot_n2/teta_u_n_bot)-(1-nbot)*(1+(tetabot_n2.*k_bot_n./mubot_n));

% Parameter c1
c_top_n1 = (tetatop_n1.*k_top_n./mutop_n)*(1-ntop)-ntop*(tetatop_n1./teta_u_n_top).^2;
c_bot_n1 = (tetabot_n1.*k_bot_n./mubot_n)*(1-nbot)-nbot*(tetabot_n1./teta_u_n_bot).^2;
% Parameter c2
c_top_n2 = (tetatop_n2.*k_top_n./mutop_n)*(1-ntop)-ntop*(tetatop_n2./teta_u_n_top).^2;
c_bot_n2 = (tetabot_n2.*k_bot_n./mubot_n)*(1-nbot)-nbot*(tetabot_n2./teta_u_n_bot).^2;

% -------- distr. moment -------------------------------------------------
% top, calculating m1 at the top of the element, normalized and non-normalized
if tetatop_n1 <= teta_u_n_top
