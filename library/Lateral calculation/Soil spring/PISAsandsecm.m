...
teta_u_n_top  = element.PISA_param(i,8);
teta_u_n_bot  = element.PISA_param(i,8);
...
a_top = 1-2*ntop;
a_bot = 1-2*nbot;
b_top_n = 2*ntop*(tetatop_n/teta_u_n_top)-(1-ntop)*(1+(tetatop_n.*k_top_n./mutop_n));
b_bot_n = 2*nbot*(tetabot_n/teta_u_n_bot)-(1-nbot)*(1+(tetabot_n.*k_bot_n./mubot_n));
c_top_n = (tetatop_n.*k_top_n./mutop_n)*(1-ntop)-ntop*(tetatop_n./teta_u_n_top).^2;
c_bot_n = (tetabot_n.*k_bot_n./mubot_n)*(1-nbot)-nbot*(tetabot_n./teta_u_n_bot).^2;

% -------- distr. moment -------------------------------------------------
%top
if tetatop_n <= teta_u_n_top
