...
if element.PISA_switch==1
    upy_top(c,:) = [0 0.0001 0.0005 0.001 0.003 0.005 0.01 0.0125 0.015 0.02 0.03 0.04 0.06 0.080 0.12 0.2 0.4 0.8 1.6];
    upy_bot(c,:) = upy_top(c,:);
end
...
for j = 1:npoints
    [ksppynode_top ksppynode_bot] = secHBstiff(settings,element,pile,[upy_bot(c,j) upy_bot(c,j)],c);
