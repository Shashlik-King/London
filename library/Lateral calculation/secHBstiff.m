function [kstop ksbot] = secHBstiff(settings,element,pile,y_topbottom,i)
%
%--------------------------------------------------------------------------
% PURPOSE
...
if settings.Apply_Direct_springs
    ...
    PLAXIS=settings.Plaxis_data.BaseShear;
    [kstop ksbot] =Direct_Sec(PLAXIS,element,pile,y_topbottom,i);
else
