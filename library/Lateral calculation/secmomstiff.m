function [ksmomtop ksmombot]  = secmomstiff(settings,element,pile,teta_topbottom,y_topbottom,kstop,ksbot,i)
% 
%--------------------------------------------------------------------------
% PURPOSE
...
if settings.Apply_Direct_springs && ~ strcmp(element.model_py(i),'Zero soil')
   ...
   PLAXIS=settings.Plaxis_data.MTheta;
    [ksmomtop ksmombot] =Direct_Sec(PLAXIS,element,pile,teta_topbottom,i);
else 
