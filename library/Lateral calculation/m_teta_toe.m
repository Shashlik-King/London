...
if element.PISA_switch==1
    teta_top(c,:) = [0 0.0000003 0.000001  0.00003 0.0001 0.0003 0.001 0.002 0.003 0.004 0.005 0.006 0.007 0.01  0.012  0.014   0.016    0.019      0.03 0.04 0.05 0.06 0.07 0.08 0.1 0.2 0.4 0.6 0.8];
...
for j = 1:npoints
    [ksmtetanode_top ksmtetanode_bot] = secMBstiff(settings,element,pile,[teta_top(c,j) teta_bot(c,j)],c);
