    ...
    if  settings.SSI2db ==1 
        ...
        elseif settings.multi_toe_levels == 2
           pile.length_start_or = pile.multi_length_start_or;
            ...
            pile.length_start_or = 49.9;
        end
       pile.length_start = pile.length_start_or ;% %increasing pile length for p-y and t-z curves so the STR team dont need updated curves for updated  pile lenghts
