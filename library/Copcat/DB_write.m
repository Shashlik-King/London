...
mysqlstr_ini        = ['INSERT INTO ',settings.db_table,' (name,project,location,rev,diameter,length,notes,soil_type,'...
    ...
    'MB_u_1,MB_u_2,MB_u_3,k_Mb_F,k_Mb_1,k_Mb_2,k_Mb_3,n_Mb_F,n_Mb_1,n_Mb_2,n_Mb_3,preparer) VALUES ('];
...
%         New.preparer = Input.preparer
        database_str = [mysqlstr_ini,'''',New.name{i},''',''',New.project{i},''',''',Input.Location_name{1,2},''',''',num2str(New.revision),''',''',num2str(2),''',''',num2str(2),''',''',New.notes{i},''',''',New.soil_type{i},''''];
        ...
        database_str = [database_str,',','''',Input.preparer{1,2},'''',');'];
        mysql(database_str)
    end
