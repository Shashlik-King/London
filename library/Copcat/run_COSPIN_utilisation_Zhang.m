...
for iii = 1:size(output.hor_defl,1)-2
    ...
    results.utilisation(iii+1,2) = (abs(output.hor_defl(iii))/output.hor_defl(iii))*interp1(y.bottom(iii,:) , p.bottom(iii,:) , abs(output.hor_defl(iii+1)));
    results.utilisation(iii+1,3) =  results.utilisation(iii+1,2) / max(p.bottom(iii,:));
