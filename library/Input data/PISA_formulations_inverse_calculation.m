...
function [element]=PISA_formulations_inverse_calculation(pile,soil,element,scour,settings,data,i)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% P-Y springs
...
elseif strcmp(element.type(i),'Sand')
    if element.PISA_prelim_param.p_y(i,5) == 0
        element.PISA_param(i,1+j) = element.PISA_prelim_param.p_y(i,6);
    elseif element.PISA_prelim_param.p_y(i,5) == 1
        element.PISA_param(i,1+j) = element.PISA_prelim_param.p_y(i,6)*(-element.level(i,j)/pile.length)+element.PISA_prelim_param.p_y(i,7);
    elseif element.PISA_prelim_param.p_y(i,5) == 2
        element.PISA_param(i,1+j) = element.PISA_prelim_param.p_y(i,6)+element.PISA_prelim_param.p_y(i,7)*exp(element.PISA_prelim_param.p_y(i,8)*(-element.level(i,j)/pile.diameter));
    else
        error('wrong type of function defined for a spring')
...
element.PISA_param(i,1+j) = max(element.PISA_param(i,1+j),0.001);
...
elseif strcmp(element.type(i),'Sand')
    if element.PISA_prelim_param.m_t(i,5) == 0
        element.PISA_param(i,8+j) = element.PISA_prelim_param.m_t(i,6);
    elseif element.PISA_prelim_param.m_t(i,5) == 1
        element.PISA_param(i,8+j) = element.PISA_prelim_param.m_t(i,6)*(-element.level(i,j)/pile.length)+element.PISA_prelim_param.m_t(i,7);
    elseif element.PISA_prelim_param.m_t(i,5) == 2
        element.PISA_param(i,8+j) = element.PISA_prelim_param.m_t(i,6)+element.PISA_prelim_param.m_t(i,7)*exp(element.PISA_prelim_param.m_t(i,8)*(-element.level(i,j)/pile.diameter));
    else
        error('wrong type of function defined for a spring')
...
% element.PISA_param(i,8+j) = max(element.PISA_param(i,8+j),0.001);
...
elseif element.PISA_prelim_param.Hb(i,1) == 1
    element.PISA_param(i,15) = element.PISA_prelim_param.Hb(i,2)*(pile.length/pile.diameter)+element.PISA_prelim_param.Hb(i,3);
...
elseif element.PISA_prelim_param.Hb(i,5) == 1
    element.PISA_param(i,16) = element.PISA_prelim_param.Hb(i,6)*(pile.length/pile.diameter)+element.PISA_prelim_param.Hb(i,7);
...
elseif element.PISA_prelim_param.Hb(i,9) == 1
    element.PISA_param(i,17) = element.PISA_prelim_param.Hb(i,10)*(pile.length/pile.diameter)+element.PISA_prelim_param.Hb(i,11);
...
elseif element.PISA_prelim_param.Hb(i,13) == 1
    element.PISA_param(i,18) = element.PISA_prelim_param.Hb(i,14)*(pile.length/pile.diameter)+element.PISA_prelim_param.Hb(i,15);
...
elseif element.PISA_prelim_param.Mb(i,5) == 1
    element.PISA_param(i,19) = element.PISA_prelim_param.Mb(i,2)*(pile.length/pile.diameter)+element.PISA_prelim_param.Mb(i,3);
...
elseif element.PISA_prelim_param.Mb(i,5) == 1
    element.PISA_param(i,20) = element.PISA_prelim_param.Mb(i,6)*(pile.length/pile.diameter)+element.PISA_prelim_param.Mb(i,7);
elseif element.PISA_prelim_param.Mb(i,5) == 2
...
elseif element.PISA_prelim_param.Mb(i,9) == 1
    element.PISA_param(i,21) = element.PISA_prelim_param.Mb(i,10)*(pile.length/pile.diameter)+element.PISA_prelim_param.Mb(i,11);
...
elseif element.PISA_prelim_param.Mb(i,13) == 1
    element.PISA_param(i,22) = element.PISA_prelim_param.Mb(i,14)*(pile.length/pile.diameter)+element.PISA_prelim_param.Mb(i,15);
